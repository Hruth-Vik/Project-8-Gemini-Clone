...
Gemini Clone is a project aimed at replicating the functionality of Gemini, powered by the Google Gemini API, using React and tailwind CSS and simplar uses of Material UI.
